...
$router->post('spb/item-condition/update/{conditionId}', 'SpbController@updateItemCondition');
...
$router->post('spb/mundur/{id}', 'SpbController@mundur');
...
$router->post('spb/purchase-order/update-tax/{poId}', 'SpbController@updatePoTax');
$router->post('spb/purchase-order/mundur/{poId}', 'SpbController@mundurPo');
